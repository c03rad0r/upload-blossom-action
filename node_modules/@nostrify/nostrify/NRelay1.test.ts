import { NostrEvent } from 'jsr:@nostrify/types@^0.36.0';
import { assert, assertEquals, assertRejects } from 'jsr:@std/assert@^0.222.1';
import { finalizeEvent, generateSecretKey } from 'npm:nostr-tools@^2.7.0';
