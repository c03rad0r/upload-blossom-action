...
/** Upload files to nostr.build or another compatible server. */ export class NostrBuildUploader {
  endpoint;
  signer;
  fetch;
  constructor(opts){
  ...
  /** nostr.build API response schema. */ static schema() {
    return z.object({
      data: z.object({
        url: z.string().url(),
...
//# sourceMappingURL=NostrBuildUploader.js.map