 ...
 */ export declare class KeyStack {
  /** Number of keys */ get length(): number;
  /**
  ...
  /** Custom output for {@linkcode Deno.inspect}. */ [Symbol.for("Deno.customInspect")](inspect: (value: unknown) => string): string;
  /** Custom output for Node's {@linkcode https://nodejs.org/api/util.html#utilinspectobject-options|util.inspect}. */ [Symbol.for("nodejs.util.inspect.custom")](depth: number, options: any, inspect: (value: unknown, options?: unknown) => string): string;
}
//# sourceMappingURL=unstable_keystack.d.ts.map